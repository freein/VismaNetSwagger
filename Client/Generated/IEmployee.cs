...
namespace visma
{
    ...
    public partial interface IEmployee
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<EmployeeDto>> GetEmployeeWithHttpMessagesAsync(string employeeCd, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
