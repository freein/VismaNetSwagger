...
namespace visma
{
    ...
    public partial interface IBranch
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<BranchDto>> GetSpecificBranchWithHttpMessagesAsync(string branchNumber, string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
