...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class CarrierQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the CarrierQueryParameters class.
        /// </summary>
        public CarrierQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the CarrierQueryParameters class.
        /// </summary>
        public CarrierQueryParameters(int? numberToRead = default(int?), int? skipRecords = default(int?), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
