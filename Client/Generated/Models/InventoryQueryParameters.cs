...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class InventoryQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the InventoryQueryParameters class.
        /// </summary>
        public InventoryQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the InventoryQueryParameters class.
        /// </summary>
        public InventoryQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string), string alternateID = default(string))
        {
