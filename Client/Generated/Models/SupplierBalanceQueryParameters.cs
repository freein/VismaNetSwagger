...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class SupplierBalanceQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the SupplierBalanceQueryParameters
        /// class.
        /// </summary>
        public SupplierBalanceQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the SupplierBalanceQueryParameters
        /// class.
        /// </summary>
        public SupplierBalanceQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
