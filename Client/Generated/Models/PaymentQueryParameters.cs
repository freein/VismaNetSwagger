...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class PaymentQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the PaymentQueryParameters class.
        /// </summary>
        ...
        /// Initializes a new instance of the PaymentQueryParameters class.
        /// </summary>
        public PaymentQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
