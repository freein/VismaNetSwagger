...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class InventoryReceiptLineDto
    {
        /// <summary>
        /// Initializes a new instance of the InventoryReceiptLineDto class.
        /// </summary>
        public InventoryReceiptLineDto() { }

        /// <summary>
        /// Initializes a new instance of the InventoryReceiptLineDto class.
        /// </summary>
        public InventoryReceiptLineDto(WarehouseIdDescriptionDto warehouse = default(WarehouseIdDescriptionDto), double? unitCost = default(double?), double? extCost = default(double?), int? lineNumber = default(int?), InventoryNumberDescriptionDto inventoryItem = default(InventoryNumberDescriptionDto), LocationDto location = default(LocationDto), double? quantity = default(double?), string uom = default(string), ReasonCodeDto reasonCode = default(ReasonCodeDto), string description = default(string))
        {
            Warehouse = warehouse;
            UnitCost = unitCost;
            ExtCost = extCost;
