...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class InventoryAdjustmentLineUpdateDto
    {
        /// <summary>
        /// Initializes a new instance of the InventoryAdjustmentLineUpdateDto
        /// class.
        /// </summary>
        public InventoryAdjustmentLineUpdateDto() { }

        /// <summary>
        /// Initializes a new instance of the InventoryAdjustmentLineUpdateDto
        /// class.
        /// </summary>
        public InventoryAdjustmentLineUpdateDto(DtoValueString warehouseId = default(DtoValueString), DtoValueNullableDecimal unitCost = default(DtoValueNullableDecimal), DtoValueNullableDecimal extCost = default(DtoValueNullableDecimal), DtoValueString receiptNumber = default(DtoValueString), string operation = default(string), DtoValueInt32 lineNumber = default(DtoValueInt32), DtoValueString inventoryNumber = default(DtoValueString), DtoValueString locationId = default(DtoValueString), DtoValueNullableDecimal quantity = default(DtoValueNullableDecimal), DtoValueString uom = default(DtoValueString), DtoValueString reasonCode = default(DtoValueString), DtoValueString description = default(DtoValueString))
        {
        ...
        public DtoValueString ReceiptNumber { get; set; }
