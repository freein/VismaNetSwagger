...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class PurchaseOrderQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the PurchaseOrderQueryParameters
        /// class.
        /// </summary>
        public PurchaseOrderQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the PurchaseOrderQueryParameters
        /// class.
        /// </summary>
        public PurchaseOrderQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
