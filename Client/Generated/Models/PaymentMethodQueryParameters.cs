...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class PaymentMethodQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the PaymentMethodQueryParameters
        /// class.
        /// </summary>
        public PaymentMethodQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the PaymentMethodQueryParameters
        /// class.
        /// </summary>
        public PaymentMethodQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
