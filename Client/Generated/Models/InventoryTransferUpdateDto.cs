...
namespace visma.Models
{
    ...
    /// </summary>
    public partial class InventoryTransferUpdateDto
    {
        /// <summary>
        /// Initializes a new instance of the InventoryTransferUpdateDto class.
        /// </summary>
        public InventoryTransferUpdateDto() { }

        /// <summary>
        /// Initializes a new instance of the InventoryTransferUpdateDto class.
        /// </summary>
        public InventoryTransferUpdateDto(DtoValueString warehouseId = default(DtoValueString), DtoValueString toWarehouseId = default(DtoValueString), IList<InventoryTransferLineUpdateDto> transferLines = default(IList<InventoryTransferLineUpdateDto>), DtoValueString referenceNumber = default(DtoValueString), DtoValueNullableBoolean hold = default(DtoValueNullableBoolean), DtoValueNullableDateTime date = default(DtoValueNullableDateTime), DtoValueString postPeriod = default(DtoValueString), DtoValueString externalReference = default(DtoValueString), DtoValueString description = default(DtoValueString), DtoValueNullableDecimal controlQuantity = default(DtoValueNullableDecimal))
        {
        ...
        public DtoValueString ToWarehouseId { get; set; }

        /// <summary>
        /// The inventory issue lines
        /// </summary>
        [JsonProperty(PropertyName = "transferLines")]
        public IList<InventoryTransferLineUpdateDto> TransferLines { get; set; }
