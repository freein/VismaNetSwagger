...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class BranchQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the BranchQueryParameters class.
        /// </summary>
        public BranchQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the BranchQueryParameters class.
        /// </summary>
        public BranchQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
