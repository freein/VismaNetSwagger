...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class InventoryDocumentQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the InventoryDocumentQueryParameters
        /// class.
        /// </summary>
        public InventoryDocumentQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the InventoryDocumentQueryParameters
        /// class.
        /// </summary>
        public InventoryDocumentQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
