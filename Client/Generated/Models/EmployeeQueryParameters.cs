...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class EmployeeQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the EmployeeQueryParameters class.
        /// </summary>
        ...
        /// Initializes a new instance of the EmployeeQueryParameters class.
        /// </summary>
        public EmployeeQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
