...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class ContactQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the ContactQueryParameters class.
        /// </summary>
        public ContactQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the ContactQueryParameters class.
        /// </summary>
        public ContactQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
