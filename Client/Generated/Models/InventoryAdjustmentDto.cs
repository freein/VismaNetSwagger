...
namespace visma.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the InventoryAdjustmentDto class.
        /// </summary>
        ...
        /// Initializes a new instance of the InventoryAdjustmentDto class.
        /// </summary>
        public InventoryAdjustmentDto(double? totalCost = default(double?), double? controlCost = default(double?), IList<InventoryAdjustmentLineDto> adjusmentLines = default(IList<InventoryAdjustmentLineDto>), string referenceNumber = default(string), string status = default(string), bool? hold = default(bool?), DateTime? date = default(DateTime?), string postPeriod = default(string), string externalReference = default(string), string description = default(string), double? totalQuantity = default(double?), double? controlQuantity = default(double?), string batchNumber = default(string), DateTime? lastModifiedDateTime = default(DateTime?))
        {
            TotalCost = totalCost;
            ControlCost = controlCost;
            AdjusmentLines = adjusmentLines;
        ...
        /// </summary>
        [JsonProperty(PropertyName = "adjusmentLines")]
        public IList<InventoryAdjustmentLineDto> AdjusmentLines { get; set; }
