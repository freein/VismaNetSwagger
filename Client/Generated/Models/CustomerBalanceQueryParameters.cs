...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class CustomerBalanceQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the CustomerBalanceQueryParameters
        /// class.
        /// </summary>
        public CustomerBalanceQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the CustomerBalanceQueryParameters
        /// class.
        /// </summary>
        public CustomerBalanceQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
