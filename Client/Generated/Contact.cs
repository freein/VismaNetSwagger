...
namespace visma
{
    ...
    /// Contact operations.
    /// </summary>
    public partial class Contact : IServiceOperations<VismanetAPI>, IContact
    {
        /// <summary>
        ...
        /// </param>
        public Contact(VismanetAPI client)
        {
            if (client == null) 
            {
        ...
        public async Task<HttpOperationResponse<IList<ContactDto>>> GetAllContactsWithHttpMessagesAsync(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GetAllContacts", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "controller/api/v1/contact").ToString();
        ...
        /// The cancellation token.
        /// </param>
        public async Task<HttpOperationResponse> CreateContactWithHttpMessagesAsync(ContactUpdateDto contact, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (contact == null)
            {
            ...
            // Serialize Request
            string _requestContent = null;
            _requestContent = SafeJsonConvert.SerializeObject(contact, this.Client.SerializationSettings);
        ...
        /// The cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<ContactDto>> GetWithHttpMessagesAsync(int? contactId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (contactId == null)
            {
            ...
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "controller/api/v1/contact/{contactId}").ToString();
            _url = _url.Replace("{contactId}", Uri.EscapeDataString(SafeJsonConvert.SerializeObject(contactId, this.Client.SerializationSettings).Trim('"')));
            // Create HTTP transport objects
            HttpRequestMessage _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("GET");
            ...
            // Create Result
            var _result = new HttpOperationResponse<ContactDto>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<ContactDto>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// The cancellation token.
        /// </param>
        public async Task<HttpOperationResponse> PutWithHttpMessagesAsync(int? contactId, ContactUpdateDto contact, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (contactId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "contactId");
