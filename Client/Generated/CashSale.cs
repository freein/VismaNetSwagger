...
namespace visma
{
    ...
    /// CashSale operations.
    /// </summary>
    public partial class CashSale : IServiceOperations<VismanetAPI>, ICashSale
    {
        /// <summary>
        /// Initializes a new instance of the CashSale class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        public CashSale(VismanetAPI client)
        {
            if (client == null) 
            {
        ...
        public async Task<HttpOperationResponse<IList<CashSaleDto>>> GetAllCashSalesWithHttpMessagesAsync(string greaterThanValue = default(string), int? released = default(int?), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GetAllCashSales", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "controller/api/v1/cashsale").ToString();
        ...
        /// The cancellation token.
        /// </param>
        public async Task<HttpOperationResponse> PostWithHttpMessagesAsync(CashSaleUpdateDto cashSaleUpdateDto, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (cashSaleUpdateDto == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "cashSaleUpdateDto");
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            if (_shouldTrace)
            {
                _invocationId = ServiceClientTracing.NextInvocationId.ToString();
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("cashSaleUpdateDto", cashSaleUpdateDto);
                tracingParameters.Add("cancellationToken", cancellationToken);
            ...
            // Serialize Request
            string _requestContent = null;
            _requestContent = SafeJsonConvert.SerializeObject(cashSaleUpdateDto, this.Client.SerializationSettings);
        ...
        /// The cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<CashSaleDto>> GetWithHttpMessagesAsync(string documentNumber, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                _invocationId = ServiceClientTracing.NextInvocationId.ToString();
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("documentNumber", documentNumber);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "Get", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "controller/api/v1/cashsale/{documentNumber}").ToString();
            _url = _url.Replace("{documentNumber}", Uri.EscapeDataString(documentNumber));
            // Create HTTP transport objects
            HttpRequestMessage _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("GET");
            ...
            // Create Result
            var _result = new HttpOperationResponse<CashSaleDto>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<CashSaleDto>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// The cancellation token.
        /// </param>
        public async Task<HttpOperationResponse> PutWithHttpMessagesAsync(string documentnumber, CashSaleUpdateDto cashSaleUpdateDto, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (documentnumber == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "documentnumber");
