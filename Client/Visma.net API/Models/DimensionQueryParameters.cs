...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class DimensionQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the DimensionQueryParameters class.
        /// </summary>
        public DimensionQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the DimensionQueryParameters class.
        /// </summary>
        public DimensionQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
