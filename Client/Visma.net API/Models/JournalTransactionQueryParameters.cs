...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class JournalTransactionQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the
        /// JournalTransactionQueryParameters class.
        /// </summary>
        public JournalTransactionQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the
        /// JournalTransactionQueryParameters class.
        /// </summary>
        public JournalTransactionQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
