...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class LedgerQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the LedgerQueryParameters class.
        /// </summary>
        public LedgerQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the LedgerQueryParameters class.
        /// </summary>
        public LedgerQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
