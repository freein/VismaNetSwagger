...
namespace visma.Models
{
    ...
    public partial class CustomerInvoiceLinesUpdateDto
    {
        ...
        public DtoValueDateTime TermStartDate { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "termEndDate")]
        public DtoValueDateTime TermEndDate { get; set; }
