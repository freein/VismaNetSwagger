...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class AccountQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the AccountQueryParameters class.
        /// </summary>
        ...
        /// Initializes a new instance of the AccountQueryParameters class.
        /// </summary>
        public AccountQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
