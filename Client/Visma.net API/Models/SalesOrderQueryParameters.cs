...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class SalesOrderQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the SalesOrderQueryParameters class.
        /// </summary>
        public SalesOrderQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the SalesOrderQueryParameters class.
        /// </summary>
        public SalesOrderQueryParameters(string orderType = default(string), string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
            OrderType = orderType;
