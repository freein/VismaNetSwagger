...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class PackagingTypeQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the PackagingTypeQueryParameters
        /// class.
        /// </summary>
        public PackagingTypeQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the PackagingTypeQueryParameters
        /// class.
        /// </summary>
        public PackagingTypeQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
