...
namespace visma.Models
{
    ...
    /// <summary>
    /// </summary>
    public partial class SupplierQueryParameters
    {
        /// <summary>
        /// Initializes a new instance of the SupplierQueryParameters class.
        /// </summary>
        public SupplierQueryParameters() { }

        /// <summary>
        /// Initializes a new instance of the SupplierQueryParameters class.
        /// </summary>
        public SupplierQueryParameters(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string))
        {
