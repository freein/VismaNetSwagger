...
namespace visma
{
    ...
    /// </summary>
    public partial interface IPackagingType
    {
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<PackagingTypeDto>> GetWithHttpMessagesAsync(string boxId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
