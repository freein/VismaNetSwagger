...
namespace visma
{
    ...
    /// Ledger operations.
    /// </summary>
    public partial class Ledger : IServiceOperations<VismanetAPI>, ILedger
    {
        /// <summary>
        ...
        /// </param>
        public Ledger(VismanetAPI client)
        {
            if (client == null) 
            {
        ...
        public async Task<HttpOperationResponse<IList<LedgerDto>>> GetAllLedgersWithHttpMessagesAsync(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GetAllLedgers", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "controller/api/v1/ledger").ToString();
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<LedgerDto>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<IList<LedgerDto>>(_responseContent, this.Client.DeserializationSettings);
                }
