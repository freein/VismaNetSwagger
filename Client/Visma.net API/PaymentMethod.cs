...
namespace visma
{
    ...
    /// </summary>
    public partial class PaymentMethod : IServiceOperations<VismanetAPI>, IPaymentMethod
    {
        /// <summary>
        ...
        /// </param>
        public PaymentMethod(VismanetAPI client)
        {
            if (client == null) 
            {
        ...
        public async Task<HttpOperationResponse<IList<PaymentMethodDto>>> GetAllPaymentMethodWithHttpMessagesAsync(string greaterThanValue = default(string), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GetAllPaymentMethod", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "controller/api/v1/paymentmethod").ToString();
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<PaymentMethodDto>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<IList<PaymentMethodDto>>(_responseContent, this.Client.DeserializationSettings);
                }
        ...
        /// The cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<PaymentMethodDto>> GetWithHttpMessagesAsync(string paymentMethodNumber, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (paymentMethodNumber == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "paymentMethodNumber");
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            if (_shouldTrace)
            {
                _invocationId = ServiceClientTracing.NextInvocationId.ToString();
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("paymentMethodNumber", paymentMethodNumber);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "Get", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "controller/api/v1/paymentmethod/{paymentMethodNumber}").ToString();
            _url = _url.Replace("{paymentMethodNumber}", Uri.EscapeDataString(paymentMethodNumber));
            // Create HTTP transport objects
            HttpRequestMessage _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("GET");
            ...
            // Create Result
            var _result = new HttpOperationResponse<PaymentMethodDto>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<PaymentMethodDto>(_responseContent, this.Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
