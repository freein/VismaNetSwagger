...
namespace visma
{
    ...
    /// </summary>
    public partial class CustomerDocument : IServiceOperations<VismanetAPI>, ICustomerDocument
    {
        /// <summary>
        /// Initializes a new instance of the CustomerDocument class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        public CustomerDocument(VismanetAPI client)
        {
            if (client == null) 
            {
        ...
        public async Task<HttpOperationResponse<IList<CustomerDocumentDto>>> GetAllDocumentsWithHttpMessagesAsync(string greaterThanValue = default(string), int? released = default(int?), int? numberToRead = default(int?), int? skipRecords = default(int?), string orderBy = default(string), string lastModifiedDateTime = default(string), string lastModifiedDateTimeCondition = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GetAllDocuments", tracingParameters);
            }
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "controller/api/v1/customerdocument").ToString();
